                  ...
                  return (
                    <div key={plan.id} className={cn("rounded-3xl border p-5 transition-all flex flex-col justify-between relative group", isCurrent ? "border-white/30 shadow-[0_0_20px_rgba(255,255,255,0.05)] bg-white/[0.02]" : "border-white/10 hover:border-white/20 bg-white/[0.01]")}>
                      ...
                      <button
                        ...
                        disabled={isCurrent}
                        className={cn("w-full py-3 font-mono text-[9px] uppercase font-bold rounded-full transition-all mt-4", isCurrent ? "glass text-zinc-600 cursor-not-allowed border-white/5" : "bg-white text-black hover:bg-zinc-200 shadow-[0_0_15px_rgba(255,255,255,0.1)] hover:shadow-[0_0_20px_rgba(255,255,255,0.2)] active:scale-95")}
                      >
