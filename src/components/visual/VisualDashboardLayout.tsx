              ...
              <h2 className="text-lg font-mono uppercase tracking-widest text-white mb-6 flex items-center gap-2 ">
                {!isSidebarOpen && (
                  <button
                    ...
                    className="md:hidden mr-2 p-1.5 hover:bg-white/10 text-zinc-400 hover:text-white rounded-lg border border-white/10 transition-colors shadow-[0_0_15px_rgba(255,255,255,0.05)]"
                  >
              ...
              <div className="glass-dark border border-white/10 rounded-3xl p-6 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-black/60 border border-white/5 rounded-3xl p-5 hover:border-white/10 transition-all flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex justify-between items-end mb-3">
                        <span className="text-2xl font-mono text-white tracking-tighter ">
                          {userState.usage.toLocaleString()} <span className="text-[10px] text-zinc-400 tracking-widest">Pulse</span>
                        </span>
                        <span className="text-[10px] font-mono text-zinc-400 tracking-widest">Limit: {userState.limit.toLocaleString()}</span>
                      </div>
                    ...
                    <p className="text-[9px] font-mono text-zinc-400 tracking-widest">Resets at the start of next billing cycle.</p>
                  </div>
                </div>
              </div>
            </motion.div>
